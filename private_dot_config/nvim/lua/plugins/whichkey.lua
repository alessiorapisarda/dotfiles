...
local mappings = {
    ...
    f = {
        name = "Telescope",
        f = { "<cmd>Telescope find_files find_command=rg,--files,--follow prompt_prefix=🔍<cr>", "Find Files" },
        h = {
    ...
    l = {
        ...
        q = { "<cmd>lua vim.set_loclist()<cr>", "Quickfix" },
    ...
    x = {
        ...
        d = { "<cmd>TroubleToggle document_diagnostics<cr>", "Document Diagnotics" },
    ...
    j = {
        ...
        l = { "<cmd>ToggleTerm size=50 direction=vertical<cr>", "Vertical" },
    },
    ...
    d = {
        ...
        v = { "<cmd>lua require('dap.ui.variables').visual_hover()<cr>", "UI Visual Hover" },
